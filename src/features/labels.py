...
marital_status_label= {0: 'Unknown', 1: 'Single', 2: 'Married/Lives with partner', 3: 'Divorced', 4: 'Widower'}

color_race_label = {0: 'Unknown', 1: 'White', 2: 'Black', 3: 'Brown', 4: 'Yellow', 5: 'Indigenous'}
...
school_type_label = {1: 'Unknown', 2: 'Public', 3: 'Private', 4: 'Foreign'}

presence_label = {0: 'Failed', 1: 'Present', 2: 'Eliminated'}
...
Q025_label = {'A': 'No', 'B': 'Yes'}

boolean_label = {0: 'No', 1: 'Yes'}
